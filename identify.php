...
<body>
    ...
    <div class="column">
        ...
        <form class="emailInput" action="" method="POST">
            ...
            <span class="span_email">E-mailadres</span>
            <?php if (isset($error)) {
        ...
        <!--De dropdown van het media account dit komt te voorschijn met javascript-->
        <div id="dropdown_DPG">
        ...
        <!--Help login het onderste gedeelte van de pagina-->
