...
foreach ($data as $artikel) {
    ...
    echo "<a href='artikel.php?artikelID=" . $artikel["berichtId"] . "'>" . $artikel["titel"] . "</a><br>";
}
?>
<hr class="divider">
...
<h2>NUshop</h2>
<a href="https://shop.nu.nl/product/fletcher-hotels?&utm_source=nushop&utm_medium=cms_banner&utm_campaign=fletcherjuni"> <a>